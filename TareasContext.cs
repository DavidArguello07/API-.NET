...
//Siempre heredar de DbContext
{
    //Configuracion de las colecciones que vamos a utilizar se convertiran en tablas
    ...
    //Configuración de cada una de las tablas
    //Fluent API Es la configuracion de la base de datos utilizando diferentes métodos de extensión que tiene esta funcionalidad de EF llamada Fluent API

    {
        ...
        modelBuilder.Entity<Categoria>(categoria=> 
        {
            ...
            //Permite agregar datos inciasles
        });
        ...
        modelBuilder.Entity<Tarea>(tarea=>
        {
            ...
            //Configuracion de la relacion de la tabla tarea con la tabla categoria
